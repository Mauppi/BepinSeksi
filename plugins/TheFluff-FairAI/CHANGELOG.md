# 1.6.1
Took out useless logs and fixed the settings to properly sync for turrets.

# 1.6.0
Fully networked all turret data so it should now sync for all clients.

# 1.5.9
Attempt to resolve turret targeting errors.

# 1.5.8
More reliable turret damaging and targeting. Turret null errors should be resolved.
